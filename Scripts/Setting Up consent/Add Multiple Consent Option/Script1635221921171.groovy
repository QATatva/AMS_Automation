...
String xpath4 = ('//ul[@id="ui-id-13"]//*[text()="' + mandopt2) + '"]'
...
String xpath5 = ('//ul[@id="ui-id-16"]//*[text()="' + setopt2) + '"]'
...
String xpath7 = ('//ul[@id="ui-id-13"]//*[text()="' + mandopt3) + '"]'
...
String xpath8 = ('//ul[@id="ui-id-16"]//*[text()="' + setopt3) + '"]'
