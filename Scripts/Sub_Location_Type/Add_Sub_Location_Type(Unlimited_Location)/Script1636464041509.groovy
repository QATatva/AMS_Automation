...
String Ltype = 'Unlimited' + Location
...
WebUI.waitForElementPresent(findTestObject('Storage Information/Sub Location Type/Add Sub Location Type/Add_New_Sub_Location_type'), 
    0)

WebUI.click(findTestObject('Storage Information/Sub Location Type/Add Sub Location Type/Add_New_Sub_Location_type'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Storage Information/Sub Location Type/Add Sub Location Type/Checkbox_NoCapacity'))
