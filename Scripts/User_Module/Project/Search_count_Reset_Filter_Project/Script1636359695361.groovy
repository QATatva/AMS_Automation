...
//WebUI.callTestCase(findTestCase('User_Module/Project/Create_Project(Quick_Links)'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Login Page/Admin_Login_Page'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.waitForPageLoad(10)

WebUI.callTestCase(findTestCase('User_Module/Project/Select_Manage_Project'), [:], FailureHandling.STOP_ON_FAILURE)
