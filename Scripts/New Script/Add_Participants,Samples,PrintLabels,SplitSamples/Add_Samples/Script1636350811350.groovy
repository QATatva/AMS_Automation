...
WebUI.switchToFrame(findTestObject('NewScript/Add_Sample(Participants)/Iframe_SelectProject'), 0)

WebUI.click(findTestObject('NewScript/Add_Sample(Participants)/Grid_ProjectID'))
...
WebUI.click(findTestObject('NewScript/Add_Sample(Participants)/Sample_Icon'))
...
WebUI.click(findTestObject('NewScript/Add_Sample(Participants)/Insert_Sample_Value(Dropdown) - 2'))
...
//
//String xpath4 = ('//*[@id="ui-id-43"]//*[text()="' + ssample) + '"]'
//
...
WebUI.click(findTestObject('NewScript/Add_Sample(Participants)/Select_Samples'))
