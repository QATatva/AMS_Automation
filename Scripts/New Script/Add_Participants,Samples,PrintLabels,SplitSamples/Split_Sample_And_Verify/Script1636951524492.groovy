...
String SampleId = WebUI.getText(findTestObject('NewScript/Split Samples/Sample_Grid_ID'))

println(SampleId)

String sampleid = WebUI.getText(findTestObject('NewScript/Split Samples/Sample_Internal_ReFNo_Grid'))

println(sampleid)

'slect sample to split'
...
/////////////////////////////////////
WebUI.switchToFrame(findTestObject('NewScript/Split Samples/Family_Overview_Iframe'), 10)

WebUI.delay(5)

WebUI.click(findTestObject('NewScript/Split Samples/Split_Sample_Grid_ID'))
...
WebUI.click(findTestObject('NewScript/Split Samples/Family_Overview_Icon'))

WebUI.switchToFrame(findTestObject('NewScript/Split Samples/Family_Overview_Iframe'), 10)

String RefId = WebUI.getText(findTestObject('NewScript/Split Samples/Sample_RefNo_Grid'))

println(RefId)

String test = WebUI.getAttribute(findTestObject('NewScript/Split Samples/Sample_RefNo_Grid'), 'value')

println(test)

//WebUI.click(findTestObject('NewScript/Split Samples/Family_Sample_GridID'))
//String SplitDonorid = WebUI.getAttribute(findTestObject('NewScript/Split Samples/Family_Sample_GridID'), 'value')
//println(SplitDonorid)
String SplitDonorid = WebUI.getText(findTestObject('NewScript/Split Samples/Family_Sample_GridID'))
...
WebUI.verifyMatch(SplitDonorid, SampleId, false)
