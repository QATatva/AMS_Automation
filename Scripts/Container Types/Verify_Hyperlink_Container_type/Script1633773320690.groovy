...
'Click on Container type hyperlink'
WebUI.click(findTestObject('Storage Information/Container Type/Container_Type/Verify Container Type Hyperlink/Verfiy_Container_Type_Hyperlink'))

WebUI.switchToWindowIndex(1)
println("Container Type Hyperlink open successfully")
