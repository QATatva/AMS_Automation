...
//Click the Sample Type hyperlink
WebUI.waitForElementVisible(findTestObject('Admin_OR/Sample Information_OR/Sample Type_OR/Sample Type hyperlink'), 10)

WebUI.click(findTestObject('Admin_OR/Sample Information_OR/Sample Type_OR/Sample Type hyperlink'))
