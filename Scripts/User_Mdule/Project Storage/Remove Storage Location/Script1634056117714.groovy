...
'Click on the \'...\' menu'
WebUI.click(findTestObject('User Module/Storage/Add Storage to Project/Click menu'))

'Select "Remove from Project" option'
WebUI.click(findTestObject('User Module/Storage/Remove project from storage/Select Remove from project menu'))
