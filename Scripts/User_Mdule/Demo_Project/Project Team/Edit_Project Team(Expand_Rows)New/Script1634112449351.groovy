...
WebUI.waitForElementPresent(findTestObject('User Module/Grid_Icons/span_Project Team tab'), 10)

WebUI.click(findTestObject('User Module/Grid_Icons/span_Project Team tab'))

WebUI.switchToFrame(findTestObject('User Module/Projects Create and Search/Edit Project via expand row/Expand Project Team iframe'), 
    10)
